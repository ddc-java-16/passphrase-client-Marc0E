...
android {
    ...
    defaultConfig {
        ...
        resValue("string","service_client_id", getLocalProperty("serviceClientId") !!) // use as if it wasn't nullable
...
dependencies {
    ...
    implementation(libs.navigation.ui) //To use navigation map to move from one fragment to another.
